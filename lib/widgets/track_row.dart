...
//         return provider is TablaPakhawajTrack
//             ? Row(
//                 children: [
//                   Expanded(
//                     child: TablaPakhawajSection(),
//                   ),
//                   Expanded(
//                     child: TablaPakhawajSection(),
//                   ),
//                 ],
//               )
//             : provider is MetronomeTrack
//                 ? Row(
//                     children: [
//                       Expanded(
//                         child: MetronomeSection(),
//                       ),
//                       Expanded(
//                         child: MetronomeSection(),
//                       ),
//                     ],
//                   )
//                 : provider is SwarmandalTrack
//                     ? Row(
//                         children: [
//                           Expanded(
//                             child: SwarmandalSection(),
//                           ),
//                           Expanded(
//                             child: SwarmandalSection(),
//                           ),
...
//                         : Card(
//                             elevation: 2,
//                             color: provider.trackOptions.isTrackOn
//                                 ? Colors.white
//                                 : Colors.grey[300],
//                             child: Padding(
...
//                                           Switch(
//                                               value: provider
//                                                   .trackOptions.isTrackOn,
//                                               onChanged: (val) {
//                                                 provider.updateFromLocal(
//                                                     provider.trackOptions
//                                                         .copyWith(
//                                                             isTrackOn: val));
//                                                 if (!val) {
//                                                   onStop(provider);
...
//                                     height: 30,
//                                     child: Text(
//                                         'Playing: ${provider.currentPlaying?.name ?? ''}'),
//                                   ),
//                                 ],
//                               ),
//                             ),
